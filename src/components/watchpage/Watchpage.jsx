  ...
  return (
    <div className='text-white h-screen flex justify-between'>
        <div className='w-[65%] px-2 py-3'>
            ...
            <div className='border ml-1 px-4 py-2 mt-2 rounded-md bg-black bg-opacity-5 hover:bg-white hover:bg-opacity-10'>
            <div className='flex justify-between   '>
                ...
                <div className='py-2 flex h-[30%]'>
                    <button className='px-4 py-2 border border-gray-400 flex items-center'>
                        <p className='mr-2'>34k</p>
                        <FaThumbsUp/>
                    </button>
                    <button className='px-4 py-2 border border-gray-400 ml-2 flex items-center'>
                        <FaThumbsDown/>
            ...
            <div className={`mt-4 ${isDescription ? 'h-full' : "h-[17vh]" } border border-b-0 border-l-0 border-r-0 py-2 px-3 overflow-hidden`}>
                <button 
            ...
            <div className='border px-3 mt-5 ml-1 rounded-lg'>
                ...
                <form action="" className='mt-3 mb-4 px-2'>
                    <input className='w-[80%] border bg-transparent text-white py-1 px-5 mr-3'
                    type="text" placeholder='Add a Comment'/>
                    <button className='border px-4 py-1 font-semibold hover:bg-gray-800'>Add</button>
                </form>
                <div className=''>
                {
                    cmt.map((item,index) => (
        ...
        <div className='bg-purple-500 w-[40%]'>
            {/* <VideoListings/> */}
        </div>
    </div>
  )
